...
describe('List of cards', () => {
 ...
 test('has same amount of cards as animals are provided', async () => {
    useGetCards.mockReturnValueOnce( [{ url: "https://cloud.modyocdn.com/uploads/4a1b66ba-ba4e-438d-be40-d9960818e06a/original/bear.jpg"
   , title: 'Bear' }]);
   render(<Home />);
